...
// Ambil data yang dikirim dari form_ubah.php melalui URL
$id = $_GET['id'];
...
// Jika user memilih file foto pada form
if (!empty($foto)) {
    ...
    } else { // Jika gambar gagal diupload, tampilkan pesan error
        echo "Maaf, Gambar gagal untuk diupload.";
        echo "<br><a href='form_ubah.php'>Kembali Ke Form</a>";
    }
} else { // Jika user tidak memilih file foto pada form
